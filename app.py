#Automação de cliques e introdução em planilha xlsx usando openpyxl e pyautogui

#Ler os dados da planilha
#inserir as informações nos respectivos campos
...
for linha in vendas_sheet.iter_rows(min_row= 2) :
    #campo nome
    pygui.click(1171, 331, duration=1.5) #as coordenadas xy são trocadas pelas que voce deseja clicar 
    pygui.write(linha[0].value)          #Coordenadas aferidas utilizando mouseInfo
    #campo produto
